    ...
    3: [
      function(require, module, exports) {
        ...
        ;(function() {
          ...
          // Controls
          var collapseExpandButton = document
            .getElementsByClassName('stryker-collapse-expand-all')
            .item(0)
          var displayCheckboxes = document.getElementsByClassName(
            'stryker-display'
          )
          ...
          function toggleMutant(mutantId, forceOpen) {
            ...
            var shouldOpen =
              forceOpen === undefined
                ? replacementMap[mutantId].hidden
                : forceOpen
            ...
            originalCodeMap[mutantId].classList.toggle(
            ...
            label.classList.toggle(
              'badge-' + button.dataset.mutantStatusAnnotation,
              !shouldOpen
            )
          }
      ...
      {
        'highlight.js/lib/highlight.js': 1,
        'highlight.js/lib/languages/javascript.js': 2
      }
    ]
  },
  {},
